...
def train_model(model,batch_size=128, epoch=5, save_file='../model/detector_model.hdf5'):
    ...
    # x_val, y_val = np.concatenate([x_train, x_extra])[-1000:], np.concatenate([y_train, y_extra])[-1000:]
...
train_model(build_model(), epoch=10, save_file='../model/detector_model_3.hdf5')
